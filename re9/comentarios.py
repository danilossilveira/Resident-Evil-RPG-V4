...
class Comentarios():
    ...
    def mensagem_dano_critico(self,dano, inimigo):
        falas = [            
        f"CRÍTICO! Você causou {dano} de dano no {inimigo}!",
        f"CRÍTICO! {inimigo} recebeu {dano} de dano!",
        f"CRÍTICO! Seu golpe causa {dano} de dano — o {inimigo} cambaleia!",
        f"CRÍTICO! {dano} de dano! O {inimigo} é atingido brutalmente!",
        f"CRÍTICO! Você acerta em cheio e causa {dano} de dano no {inimigo}!",
